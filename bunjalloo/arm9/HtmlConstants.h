...
*/
#ifndef HtmlConstants_h_seen
#define HtmlConstants_h_seen
...
class HtmlConstants
{
  public:
    ...
    const static char PLAINTEXT_TAG[];
    const static char PRE_TAG[];
    const static char P_TAG[];
    const static char SCRIPT_TAG[];
